...
export default function TerminiCondizioniPage() {
 ...
 <p className="text-gray-700 leading-relaxed">
 Tutti i prodotti BellaCura sono coperti dalla garanzia legale di conformità di 2 anni prevista dal Codice del Consumo (D.Lgs. 206/2005). In aggiunta, offriamo la nostra <Link href="/garanzia/" className="text-[#1D3557] hover:underline">Garanzia Soddisfatti o Rimborsati 90 giorni</Link>.
 </p>
 </section>
 ...
 <div className="font-semibold text-gray-900 text-sm">Garanzia 90 giorni</div>
 </Link>
