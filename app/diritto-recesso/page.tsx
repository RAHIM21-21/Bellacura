...
export const metadata: Metadata = {
 ...
 description: 'Come esercitare il diritto di recesso e richiedere un reso o rimborso su BellaCura. Procedura semplice entro 90 giorni.',
...
export default function DirittoRecessoPage() {
 ...
 <h2 className="text-2xl font-bold text-gray-900 mb-2">90 giorni per ripensarci</h2>
 <p className="text-gray-600 max-w-lg mx-auto">
 Puoi restituire qualsiasi prodotto entro 90 giorni dalla consegna, senza dover fornire alcuna spiegazione. Rimborso completo garantito.
 </p>
 </div>
 ...
 <strong>BellaCura amplia questo diritto a 90 giorni</strong>, offrendoti il doppio del tempo previsto dalla legge per valutare il prodotto con calma.
 </p>
 </section>
 ...
 Invia una email a <a href="mailto:resi@bellacura.it" className="text-[#1D3557] hover:underline">resi@bellacura.it</a> con oggetto <em>&quot;Reso ordine #[numero ordine]&quot;</em>, oppure scrivici su WhatsApp al numero indicato nella <Link href="/contatti/" className="text-[#1D3557] hover:underline">pagina contatti</Link>.
 </p>
 </div>
 </div>
 ...
 className="flex-1 block text-center bg-[#1D3557] text-white px-6 py-4 rounded-full font-semibold hover:bg-[#152840] transition-colors"
 >
 Richiedi il reso
 </a>
 <Link
