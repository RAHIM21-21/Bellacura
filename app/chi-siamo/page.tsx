...
export default function ChiSiamoPage() {
 ...
 { icon: '', title: 'Clienti Prima di Tutto', desc: 'Reso gratuito 90 giorni, garanzia 12 mesi, supporto dedicato per ogni ordine.' },
 ].map((v) => (
 ...
 <Link href="/anticellulite-v2" className="inline-flex items-center justify-center px-8 py-3 bg-white text-[#1D3557] font-bold rounded-full hover:bg-[#DCEAF2] transition-colors">Massaggiatore Anticellulite</Link>
