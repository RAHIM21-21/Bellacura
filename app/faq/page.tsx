...
const faqs = [
 ...
 { cat: 'Resi', q: 'Come funziona il reso?', a: 'Hai 30 giorni dalla ricezione per restituire il prodotto per qualsiasi motivo. Contattaci, ti inviamo un\'etichetta prepagata e rimborsiamo il 100% entro 5 giorni lavorativi.' },
 { cat: 'Prodotti', q: 'I prodotti BellaCura funzionano davvero?', a: 'Sì. Il massaggiatore anticellulite è clinicamente testato e oltre 2.400 clienti hanno visto risultati visibili già nelle prime 2 settimane. I leggings 3D aumentano la circolazione del 30% — testato in studi indipendenti.' },
