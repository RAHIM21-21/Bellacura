      ...
      <section className="bc-tech-section" style={{ background: '#FBF8F4', padding: '80px 0 88px' }}>
        <style>{`
          @media (max-width: 767px) {
            .bc-tech-section { padding: 44px 0 52px !important; }
 ...
 */}
 ...
 FINAL CTA
 */}
 <section className="py-10 md:py-16" style={{background: 'linear-gradient(135deg, #F5C8D6 0%, #EAB0C2 50%, #F2C2CE 100%)'}}>
 ...
 <p className="text-gray-500 text-sm mb-3">Completa la tua routine anticellulite</p>
 <Link
