...
export default function GaranziaPage() {
 ...
 Ordina con fiducia. Se per qualsiasi motivo non sei soddisfatta, restituisci il prodotto entro 90 giorni e ti rimborsiamo il 100% — nessuna domanda.
 </p>
 </div>
 </section>
 ...
 {[
 { icon: '', title: '90 Giorni', sub: 'Hai 90 giorni dalla ricezione per restituire il prodotto, anche se aperto e usato.' },
 ...
 {[
 { n: '1', t: 'Contattaci entro 90 giorni', d: 'Scrivi a reso@bellacura.it o contattaci via WhatsApp con il numero d\'ordine e il motivo (opzionale).' },
 ...
 <Link href="/anticellulite-v2" className="btn-primary">Massaggiatore Anticellulite</Link>
