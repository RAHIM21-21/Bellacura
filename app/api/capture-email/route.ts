  ...
  try {
      ...
      html: `
        <div style="font-family: sans-serif; max-width: 500px; margin: 0 auto; padding: 24px;">
          <div style="background: #1D3557; padding: 20px 24px; border-radius: 12px 12px 0 0;">
            ...
            <p style="color: #DCEAF2; margin: 4px 0 0; font-size: 14px;">Popup sconto 10%</p>
          </div>
    ...
    await resend.emails.send({
      ...
      html: `
        ...
        <body style="margin:0; padding:0; background:#EEF6FB; font-family: Georgia, 'Times New Roman', serif;">
          <div style="max-width: 560px; margin: 0 auto; padding: 32px 16px;">
            ...
            <div style="background: linear-gradient(135deg, #1D3557, #152840); border-radius: 16px 16px 0 0; padding: 36px 32px; text-align: center;">
              <p style="margin: 0 0 8px; color: #DCEAF2; font-size: 12px; letter-spacing: 3px; text-transform: uppercase; font-family: sans-serif;">Offerta Esclusiva</p>
              <h1 style="margin: 0; color: #ffffff; font-size: 32px; font-weight: bold;">🎁 Il tuo -10%</h1>
              <p style="margin: 10px 0 0; color: #DCEAF2; font-size: 15px; font-family: sans-serif;">è pronto per te</p>
            </div>
            ...
            <div style="background: #ffffff; border: 1px solid #DCEAF2; border-top: none; border-radius: 0 0 16px 16px; padding: 36px 32px;">
              ...
              <div style="text-align: center; margin: 28px 0;">
                <a href="https://bellacura-shop.myshopify.com/cart/48232541651102:1?checkout"
                   style="display: inline-block; background: linear-gradient(135deg, #1D3557, #152840); color: #ffffff; text-decoration: none; font-family: sans-serif; font-weight: bold; font-size: 17px; padding: 16px 36px; border-radius: 50px;">
                  → Riscatta il tuo 10% di sconto
                </a>
                <p style="margin: 10px 0 0; color: #9ca3af; font-size: 12px; font-family: sans-serif;">Il codice <strong style="color:#457B9D;">BELLA10</strong> è già applicato automaticamente ✨</p>
              </div>

              <!-- Divider -->
              <div style="border-top: 1px solid #DCEAF2; margin: 28px 0;"></div>
