...
export default function CheckoutPage() {
 ...
 <input
 {...register('nome', { required: 'Nome richiesto', minLength: { value: 2, message: 'Minimo 2 caratteri' } })}
 ...
 <input
 {...register('email', { required: 'Email richiesta', pattern: { value: /^\S+@\S+\.\S+$/, message: 'Email non valida' } })}
 type="email"
 ...
 <input
 {...register('telefono', { required: 'Telefono richiesto', minLength: { value: 9, message: 'Numero non valido' } })}
 type="tel"
 ...
 <input
 {...register('indirizzo', { required: 'Indirizzo richiesto' })}
 ...
 <input
 {...register('civico', { required: 'Civico richiesto' })}
 ...
 <input
 {...register('cap', { required: 'CAP richiesto', pattern: { value: /^\d{5}$/, message: '5 cifre' } })}
 ...
 <select
 {...register('provincia', { required: 'Provincia richiesta' })}
 ...
 <Link href="/privacy-policy/" className="text-rose-500 underline" target="_blank">
 Privacy Policy
 </Link>{' '}
 e i{' '}
 <Link href="/termini-condizioni/" className="text-rose-500 underline" target="_blank">
 ...
 <div className="w-16 h-16 rounded-xl bg-rose-50 flex items-center justify-center text-3xl flex-shrink-0">
 {product.image}
 </div>
 <div>
 ...
 Stai risparmiando €{(product.originalPrice - product.price).toFixed(2)}!
 </p>
 </div>
 ...
 "Prodotto fantastico, arrivato in 3 giorni e ho pagato alla consegna senza problemi!" — Giulia R., Roma
 </p>
 </div>
 </div>
 </div>
