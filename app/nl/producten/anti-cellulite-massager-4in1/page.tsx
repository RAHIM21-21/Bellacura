...
export const metadata: Metadata = {
  ...buildMetadata({
    title: 'Anti-Cellulite Massager 4-in-1 – Zichtbaar Resultaat in 14 Dagen',
    description:
      'De professionele anti-cellulite massager voor thuis. Cupping + warmte 45°C + rood licht + vibratie. Zichtbare resultaten in 2 weken. Gratis verzending vanuit Italië.',
    path: '/nl/producten/anti-cellulite-massager-4in1/',
    ogImage: `${SITE_URL}/images/product-green-hero.jpg`,
  }),
  keywords: [
    'anti cellulite massager', 'cellulite behandeling thuis', 'anti cellulite apparaat',
    'sinaasappelhuid verminderen', 'massager cellulite', 'cellulite massager elektrisch',
    'cupping massager', 'lichaamsmassager cellulite',
  ].join(', '),
}

const faqs = [
  {
    question: 'Hoe werkt de 4-in-1 anti-cellulite massager?',
    answer: 'De BellaCura combineert 4 technologieën: cupping (vacuüm), warmte tot 45°C, rood licht en vibratie. Samen stimuleren ze de bloedsomloop, draineren ze overtollig vocht en verminderen ze cellulite zichtbaar.',
  },
  {
  ...
  },
  {
    ...
    answer: 'Een enkele anti-cellulite behandeling in een salon kost gemiddeld €60–€100. Met BellaCura betaal je eenmalig €59,95 en heb je onbeperkt behandelingen thuis, wanneer jij wilt. Veel klanten besparen honderden euro\'s per jaar.',
  },
  {
...
export default function ProductPageNL() {
  const schema_product = productSchema({
    name: 'BellaCura Anti-Cellulite Massager 4-in-1',
    description: 'Professionele anti-cellulite massager met cupping, warmte 45°C, rood licht en 5 intensiteitsniveaus. Waterbestendig IPX7.',
  ...
  const schema_breadcrumb = breadcrumbSchema([
    ...
    { name: 'Anti-Cellulite Massager 4-in-1', url: SITE_URL + '/nl/producten/anti-cellulite-massager-4in1/' },
  ])
          ...
          <div className="md:hidden space-y-2 mb-3">
            <div>
              ...
              <h1 className="text-3xl font-extrabold text-gray-900 leading-tight">
                Anti-Cellulite Massager 4-in-1™
              </h1>
            </div>
      ...
      <section className="py-8 md:py-14" style={{background: '#1D3557'}}>
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid md:grid-cols-3 gap-3 md:gap-6">
            {[
              { pct: 92, label: '92%', text: 'Zichtbare vermindering van cellulite al in de eerste week.' },
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <div className="max-w-md mx-auto w-full px-0 sm:px-8">
            <BeforeAfterSlider
              ...
              alt="BellaCura anti-cellulite resultaten"
              aspectRatio="120%"
            />
          </div>
        </div>
      ...
      <div className="fixed bottom-0 left-0 right-0 z-40 bg-white border-t border-gray-200 shadow-2xl">
        ...
        <div className="hidden md:flex items-center justify-between max-w-6xl mx-auto px-6 py-3 gap-6">
          <div className="flex items-center gap-4">
            <span className="font-extrabold text-gray-900 text-base">Anti-Cellulite Massager 4-in-1™</span>
