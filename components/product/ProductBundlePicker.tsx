...
export default function ProductBundlePicker() {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="pt-1">
        <a
          href={selected === 'double' ? 'https://bellacura-shop.myshopify.com/cart/48232541651102:1?checkout' : 'https://bellacura-shop.myshopify.com/cart/48238649606302:1?checkout'}
