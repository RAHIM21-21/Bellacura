...
export default function WhatsAppButton() {
  return (
    <div className="fixed bottom-[96px] md:bottom-[80px] right-4 md:right-6 z-[998] flex items-center gap-2">
      ...
      <div className="bg-white rounded-2xl shadow-lg px-3 py-2 border border-gray-100 hidden md:block">
        ...
        <p className="text-[10px] text-gray-500 whitespace-nowrap">Scrivici ora 💬</p>
      </div>
